...
//a =20  20%
//b = 10 10%    expense/totalincome *100
//c =40 40%
//income = 100
...
var DOMstrings = {
  ...
  var  formatNumber =  function(num, type) {
      ...
      /*
        ...
        2000 --> + 2,000.00
      */
      num = Math.abs(num); // to remove  + or - sign.
      num = num.toFixed(2);
      numSplit = num.split('.');
      ...
      if(int.length > 3) {
        ...
        // input 2310 output 2,310  input 23510 output = 23,510  235,100
      }
  ...
  return {
          ...
          html =  '<div class="item clearfix" id="exp-%id%"><div class="item__description">%description%</div><div class="right clearfix"><div class="item__value">%value%</div><div class="item__percentage">21%</div><div class="item__delete"><button class="item__delete--btn"><i class="ion-ios-close-outline"></i></button></div></div></div>'
            ...
            displayPercentages: function(percentages) {
              ...
              var fields = document.querySelectorAll(DOMstrings.expensesPercLabel); //RETURNS NODELIST INSTEAD OF ARRAY.
